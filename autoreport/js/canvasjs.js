...
(function () {
	...
	ToolTip.prototype._initialize = function () {
		...
		if (this.enabled) {
			...
			toolTipHtml += "font-family: HelveticaCyrThin, Arial, Georgia, serif;";
			toolTipHtml += "font-style: normal;";
			toolTipHtml += "font-size: 22px;";
			...
			toolTipHtml += isCanvasSupported ? "background: rgba(49,145,187,.9);" : "background: rgb(255,255,255);";

			toolTipHtml += "text-indent: 0px;";
			toolTipHtml += "white-space: nowrap;";
			//toolTipHtml += "pointer-events:none;";
			toolTipHtml += "border-radius: 0px;";
